    ...
    <PublicShell>
      <main className="public-main">
        <header className="public-page-head">
          ...
          <p>No account or local setup is required. Whether the work is self-directed or facilitated, a current desktop browser is recommended; all case data and code execution remain on the learner’s device.</p>
        </header>
