...
export const metadata: Metadata = {
  ...
  description: 'Compare roles, prerequisites, workload, SQL and Python demands, and complexity across nine Meridian workplace assignments.',
};
            ...
            <article key={scenario.id} className="project-record">
              ...
              <div className="project-capability-row">
                {complexityDimensions.map(({ key, label }) => (
                  <div key={key}>
                    <span>{label}</span>
                    <meter aria-label={`${label} level`} min={1} max={5} value={scenario.complexity[key]} />
                    <strong>
