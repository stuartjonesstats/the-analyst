...
export const metadata: Metadata = {
  ...
  description:
    'Nine browser-based data science assignments and a permanent weekly rotation of 16 Priority Briefs where analysts investigate a living company, make defensible decisions, and show their work.',
  openGraph: {
    title: 'The Analyst',
